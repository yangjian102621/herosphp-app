...
(function($) {
	...
	$.fn.jpreview = function() {
		...
		$(this).on("click", function() {
			...
			var timer = 500;
			var $lock = $('<div style="position: absolute; background: #000000; opacity: .6; z-index: 19891014; display: none;"></div>');
			var $imgBox = $('<div style="display: none; position: absolute; z-index: 19891015; "></div>');
			var $img = $('<img src="" />');
			$img.css({
