...
class IPFS
{
    ...
    public function add($filepath, $pin = true)
    {
        $query_vars = [
            'pin' => ($pin ? 'true' : 'false'),
            'access_key' => '213a0bd36706123286ddf28def80fcb05d83c9ca00000001000000025cfe0323'
        ];
     ...
     * }
     * @param string|array $filepath_or_filepaths a single filepath or an array of filepaths to upload
     * @param boolean $pin pin the file (true)
